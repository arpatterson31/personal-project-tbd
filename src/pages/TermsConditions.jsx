...
const TermsConditions = () => {
  return (
    <>
      ...
      <Typography variant="h5">3.1 Eligibility:</Typography>
      <Typography variant="body1">To use DevConnect, you must be at least 18 years old or the age of legal majority in your jurisdiction. By registering, you represent and warrant that you meet these eligibility requirements.</Typography>

      <Typography variant="h5">3.2 Account Information:</Typography>
      <Typography variant="body1">When registering, you agree to provide accurate and complete information. You are responsible for maintaining the confidentiality of your account credentials and for any activity that occurs under your account.</Typography>

      <Typography variant="h4">4. User Content</Typography>

      <Typography variant="h5">4.1 Content Ownership:</Typography>
      <Typography variant="body1">You retain ownership of any content you post on DevConnect. By posting content, you grant DevConnect a non-exclusive, worldwide, royalty-free, sublicensable, and transferable license to use, reproduce, modify, adapt, publish, translate, distribute, and display such content for the purpose of operating and improving the platform.</Typography>

      <Typography variant="h5">4.2 Responsibility for Content:</Typography>
      <Typography variant="body1">You are solely responsible for the content you post on DevConnect. Content must comply with applicable laws and must not infringe on the rights of third parties. DevConnect reserves the right to remove or modify any content that violates these terms.</Typography>

      <Typography variant="h4">5. User Conduct</Typography>

      <Typography variant="h5">5.1 Prohibited Activities:</Typography>
      <Typography variant="body1">When using DevConnect, you agree not to:</Typography>
      <Box component="ul">
      ...
      <Typography variant="h5">6.1 DevConnect Content:</Typography>
      <Typography variant="body1">All content provided by DevConnect, including logos, trademarks, graphics, and text, is the property of DevConnect and is protected by copyright and other intellectual property laws.</Typography>

      <Typography variant="h5">6.2 User Contributions:</Typography>
      <Typography variant="body1">Users retain ownership of their content, as stated in Section 4.1. Users are responsible for ensuring that their content does not infringe on the intellectual property rights of others.</Typography>
